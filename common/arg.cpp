...
common_params_context common_params_parser_init(common_params & params, llama_example ex, void(*print_usage)(int, char **)) {
    ...
    add_opt(common_arg(
        {"--moe-offload"},
        "enable SSD-backed MoE expert offload for GGUFs repacked with llama-moe-repack",
        [](common_params & params) {
    ...
    add_opt(common_arg(
        {"--moe-cache-vram-mb"}, "N",
        "VRAM budget for the persistent MoE expert cache, in MiB",
        [](common_params & params, int value) {
            if (value < 0) {
                throw std::invalid_argument("invalid value");
            }
    ...
    add_opt(common_arg(
        ...
        "fraction of free VRAM to reserve for the persistent MoE expert cache",
        [](common_params & params, const std::string & value) {
